...
// Renombramos para evitar conflictos con MEDIC++
void inicializarExamen() {
    // system("mkdir registros"); // Si ya usas MEDIC, la carpeta ya existe, pero no daña dejarlo
    // En Windows para evitar errores si la carpeta ya existe:
...
// ESTA FUNCION REEMPLAZA AL MAIN ORIGINAL
void menuPeliculas() {
    inicializarExamen(); // Llamamos a la version renombrada

    bool salir = false;
    int opcion;

    do {
        system("cls"); // Limpieza de pantalla para que se vea bien
        cout << "\t" << "===============================\n";
        cout << "\t" << "   SISTEMA DE PELICULAS (EXAMEN)  \n";
        cout << "\t" << "===============================\n";
        ...
        cout << "3. Modificar\n";
        cout << "4. Borrar\n";
        cout << "5. Regresar al Menu Unidad 3\n"; // Cambiado texto
        cout << "Opcion: ";
        ...
        switch(opcion) {
            case 1: registrarPelicula(); system("pause"); break;
            case 2: buscarPelicula(); system("pause"); break;
            case 3: modificarPelicula(); system("pause"); break;
            case 4: eliminarPelicula(); system("pause"); break;
            case 5: salir = true; break;
        }

    } while (!salir);

    cout << "Cerrando modulo Peliculas...\n";
}